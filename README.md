databox-export-service - export service for databox platform [![Build Status](https://travis-ci.org/tsh-box/core-export-service.svg?branch=master)](https://travis-ci.org/tsh-box/core-export-service)
-------------------------------------------------------------------------------
%%VERSION%%
...
export-service can be installed with `opam`:
	...
	opam pin -n add export-service https://github.com/tsh-box/core-export-service.git
